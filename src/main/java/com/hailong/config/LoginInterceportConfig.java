...
import com.hailong.interceptor.LoginInterceptor;
...
public class LoginInterceportConfig extends WebMvcConfigurerAdapter {
	...
	public void addInterceptors(InterceptorRegistry registry) {
		//除了/login外的所有的请求都要拦截
		registry.addInterceptor(getLoginInterceptor()).addPathPatterns("/**").excludePathPatterns("/login.action","/loginIn.action");
	}
